...
- **Una orden puede tener varios productos de tipos completamente distintos**, cada uno con su propio set de atributos. Ejemplos reales encontrados:
  - _Esquinero Nube_: Medida, Brazo, Base, Patas, Tela, Almohadón de asiento (densidad), Almohadón de respaldo, Orientación.
  - _Chester Industrial_: Medida, Brazo, Base, Patas, Tela, Almohadón de asiento, Tachas (con foto de color elegido).
  - _Retapizado_ (servicio sobre un mueble del cliente, no fabricación nueva): Tela, Almohadón de asiento, Patas.
  - _Almohadón decorativo / Pillow_: Medida, Tela — nada más.
...
| Rol fábrica                      | Ve datos técnicos y fichas (croquis, atributos, etapas de producción) **y también el detalle completo de la orden, incluyendo precios y pagos** — solo lectura, no puede editar nada salvo el estado de la orden.                                                                            |
...
7. _(Futuro)_ Reportes de costos, reportes semanales/mensuales/anuales, circuito de proveedores externos.
